...
public class Ripemd160 {
    ...
    public UInteger getPrefix() {
        ByteBuffer buffer = new ByteBuffer();
        buffer.write(value);
        return buffer.readUint32(4);
    }

    public static Ripemd160 fromString(String s) {
        return new Ripemd160(Utils.hex2bin(s));
    }

    public String toString() {
        return Utils.bin2hex(value);
    }
}
